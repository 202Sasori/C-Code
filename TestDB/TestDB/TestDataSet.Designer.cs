...
namespace TestDB {
    ...
    public partial class TestDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(int StudentID, string StudentName, int Age, string Email) {
...
namespace TestDB.TestDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Students] WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_StudentName = 1 AND [StudentName] IS NULL) OR ([StudentName] = @Original_StudentName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([StudentID], [StudentName], [Age], [Email]) VALUES " +
                "(@StudentID, @StudentName, @Age, @Email);\r\nSELECT StudentID, StudentName, Age, E" +
                "mail FROM Students WHERE (StudentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [StudentID] = @StudentID, [StudentName] = @StudentName, [Age] = @Age, [Email] = @Email WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_StudentName = 1 AND [StudentName] IS NULL) OR ([StudentName] = @Original_StudentName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT StudentID, StudentName, Age, Email FROM Students WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TestDB.Properties.Settings.Default.TestConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, StudentName, Age, Email FROM dbo.Students";
        ...
        public virtual int Delete(int Original_StudentID, string Original_StudentName, global::System.Nullable<int> Original_Age, string Original_Email) {
        ...
        public virtual int Insert(int StudentID, string StudentName, global::System.Nullable<int> Age, string Email) {
        ...
        public virtual int Update(int StudentID, string StudentName, global::System.Nullable<int> Age, string Email, int Original_StudentID, string Original_StudentName, global::System.Nullable<int> Original_Age, string Original_Email) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string StudentName, global::System.Nullable<int> Age, string Email, int Original_StudentID, string Original_StudentName, global::System.Nullable<int> Original_Age, string Original_Email) {
            return this.Update(Original_StudentID, StudentName, Age, Email, Original_StudentID, Original_StudentName, Original_Age, Original_Email);
        }
    }
